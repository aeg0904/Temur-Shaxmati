...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  await loadCurrentUser();
  updateNavbar();
  // Auth tekshiruvi TUGADI — currentUser endi ishonchli. Boshqa
  // modullar (masalan presence.js) buni kutib turishi mumkin, aks
  // holda ular currentUser hali null bo'lgan paytda ishga tushib,
  // foydalanuvchini noto'g'ri (mehmon) ID bilan belgilab qo'yishi
  // mumkin edi.
