...
const OnlineGame = {
  ...
  async init() {
    ...
    // subscribeToPresence() endi chaqirilmaydi — presence.js buni
    // sahifa yuklanganda avtomatik boshqaradi.
...
if (!claimed || claimed.length < 2) {
  // Claim muvaffaqiyatsiz. Bu yerda ikkita holat bo'lishi mumkin:
...
async handleTimeout(timedOutColor) {
  ...
  // ============================================================
  // online/online.js
  // subscribeToPresence() olib tashlandi — presence.js dagi
  // initPresence() allaqachon 'site-online-users' kanalini boshqaradi
  // va #online-count ni yangilaydi. Ikkita alohida kanal bo'lishi
  // shart emas.
